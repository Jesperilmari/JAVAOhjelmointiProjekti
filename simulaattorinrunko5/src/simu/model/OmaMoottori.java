...
public class OmaMoottori extends Moottori{
	...
	public OmaMoottori(IControllerMtoV kontrolleri){
		super(kontrolleri);
			...
			//
			palvelupisteet[1]=new Palvelupiste(new Normal(5, 1), tapahtumalista, TapahtumanTyyppi.lahtoporttiInEU, 2);

			//
			palvelupisteet[2]=new Palvelupiste(new Normal(5, 1), tapahtumalista, TapahtumanTyyppi.lahtoporttiInMuu, 3);
